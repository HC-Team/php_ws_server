...
class PHPWebSocket
{
	...
	public $chanel_list     = array();
	public $chanel_follow_list= array();
	...
	*/
	...
	function wsAddClient($socket, $clientIP) {
		...
		$this->wsClients[$clientID] = array($socket, '', self::WS_READY_STATE_CONNECTING, time(), false, 0, $clientIP, false, 0, '', 0, 0,0,'room'=>'');
